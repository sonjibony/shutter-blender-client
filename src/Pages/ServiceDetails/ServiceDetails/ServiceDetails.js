...
{/* review message */}
            ...
            {
             allReviews.length >0?
                   <h2 className="text-3xl mt-5 mb-10 text-center">{allReviews.length} reviews were added</h2>
            :
            <h2 className="text-3xl mt-5 mb-10 text-center">No reviews were added</h2>
            }
...
:
<>
<h1 className='text-3xl font-bold text-center my-6'>PLEASE LOGIN TO ADD A REVIEW</h1>
