    ...
    <div className="mt-10 mb-20">
      ...
      <div className="flex flex-wrap justify-center gap-6 my-9">
        <div className=" md:px-2 w-20 md:w-32  lg:w-52 py-2 border-r-4 border-black text-center">
          <h1
            className=" text-xl sm:text-2xl md:text-4xl lg:text-7xl mb-3 font-bold text-green-400"
          >
            200+
          </h1>
        ...
        <div className=" md:px-2 w-20 md:w-32 lg:w-52 py-2 border-r-4 border-black text-center">
          <h1
            className=" text-xl sm:text-2xl md:text-4xl lg:text-7xl mb-3 text-green-400 font-bold"
          >
            7
          </h1>
